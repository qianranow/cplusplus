...
void test07()
{
    string email = "qianranow@163.com";
    int pos = email.find("@");
    string username = email.substr(0, pos);
    cout << username << endl;
    string post = email.substr(pos+1);
    cout << post << endl;
}
...
//字符串内存重新分配，[]和at获取的字符引用，再次使用时，可能会出错
void test10()
{
    string s = "abcde";
    char &a = s[2];
    ...
    s = "abcdeabcdeabcdeabcdeabcdeabcdeabcdeabcdeabcdeabcde";
